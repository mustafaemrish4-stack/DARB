...
export const VRVideoPlayer = ({ initialVideoUrl, onClose }: VRVideoPlayerProps) => {
  ...
  const videoCatalog = [
    { id: 1, title: 'الرحلة الأولى', url: '/videos/vr_video_1.mp4' },
    { id: 2, title: 'الرحلة الثانية', url: '/videos/vr_video_2.mp4' },
    { id: 3, title: 'سبونج بوب 360', url: '/videos/vr_video_3.mp4' },
    { id: 4, title: 'الرحلة الرابعة', url: '/videos/vr_video_4.mp4' },
    { id: 5, title: 'الرحلة الخامسة', url: '/videos/vr_video_5.mp4' },
    { id: 6, title: 'الرحلة السادسة', url: '/videos/vr_video_6.mp4' },
    { id: 7, title: 'الرحلة السابعة', url: '/videos/vr_video_7.mp4' },
  ];
